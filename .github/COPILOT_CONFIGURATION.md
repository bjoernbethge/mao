...
Specialized guidelines for different file types:
...
### 3. Development Environment Setup (`.github/copilot-setup-steps.yml`)
...
### 4. Custom Agents (`.github/copilot/agents.yaml`)
...
2. **Path-specific instructions** are automatically applied when Copilot works on matching file patterns
...
- **Update regularly**: Keep instructions current as architecture or practices evolve
- **Be specific**: Provide clear, actionable guidance that Copilot can follow
- **Include examples**: Show concrete code examples for patterns and practices
- **Test changes**: Verify that instruction updates improve Copilot's code quality
