...
class TeamCreate(BaseModel):
    ...
    supervisor_id: Optional[str] = Field(
        None, description="ID of supervisor agent (if any)"
    )
    config: Optional[Dict[str, Any]] = Field(
        None, description="Team configuration parameters"
    )
...
class TeamMemberCreate(BaseModel):
    ...
    order_index: Optional[int] = Field(
        None, description="Order in sequential workflows"
    )
    is_active: bool = Field(
        True, description="Whether this agent is active in the team"
    )
    params: Optional[Dict[str, Any]] = Field(
        None, description="Role-specific parameters"
    )
...
class TeamMemberUpdate(BaseModel):
    ...
    is_active: Optional[bool] = Field(
        None, description="Whether this agent is active in the team"
    )
    params: Optional[Dict[str, Any]] = Field(
        None, description="Role-specific parameters"
    )
...
class SupervisorUpdate(BaseModel):
    ...
    agent_id: Optional[str] = Field(
        None, description="ID of the agent to use as supervisor"
    )
    system_prompt: Optional[str] = Field(
        None, description="System prompt override for supervisor"
    )
    ...
    add_handoff_back_messages: Optional[bool] = Field(
...
class ServerCreate(BaseModel):
    ...
    transport: str = Field(
        ..., description="Transport type (stdio, sse, websocket, etc.)"
    )
...
class ToolCreate(BaseModel):
    ...
    server_id: Optional[str] = Field(
        None, description="ID of the server providing this tool"
    )
    description: Optional[str] = Field(None, description="Tool description")
    parameters: Optional[Dict[str, Any]] = Field(
        None, description="Tool parameters schema"
    )
...
class ToolUpdate(BaseModel):
    ...
    enabled: Optional[bool] = Field(
        None, description="Whether the tool is enabled by default"
    )
    server_id: Optional[str] = Field(
        None, description="ID of the server providing this tool"
    )
...
class AssignToolRequest(BaseModel):
    ...
    enabled: bool = Field(
        True, description="Whether the tool is enabled for this agent"
    )
...
class AgentResponseMessage(BaseModel):
    ...
    details: Optional[Dict[str, Any]] = Field(
        None, description="Additional response details"
    )
...
class TeamResponseMessage(BaseModel):
    ...
    responding_agent_id: Optional[str] = Field(
